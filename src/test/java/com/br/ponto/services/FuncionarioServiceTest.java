...
import com.br.ponto.repositories.FuncionarioRepository;;
...
public class FuncionarioServiceTest {
	...
	public void setUp() throws Exception {
		...
		BDDMockito.given(this.funcionarioRepository.findById(Mockito.any(Long.class))).willReturn(Optional.of(new Funcionario()));
